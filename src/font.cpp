...
void createCharmap(CharMap& charmap, char32_t from, char32_t to) {
    std::unordered_map<char32_t, CharBitmap> ascii = {
        ...
        {0x21, {8, 8, 8, 8, 0, 0, 8, 0}},
        {0x22, {36, 36, 36, 0, 0, 0, 0, 0}},
        {0x23, {36, 36, 126, 36, 126, 36, 36, 0}},
        {0x24, {8, 30, 40, 28, 10, 60, 8, 0}},
        {0x25, {0, 98, 100, 8, 16, 38, 70, 0}},
        {0x26, {48, 72, 72, 48, 74, 68, 58, 0}},
        {0x27, {8, 8, 8, 0, 0, 0, 0, 0}},
        {0x28, {4, 8, 16, 16, 16, 8, 4, 0}},
        {0x29, {32, 16, 8, 8, 8, 16, 32, 0}},
        {0x2a, {8, 42, 28, 62, 28, 42, 8, 0}},
        {0x2b, {0, 8, 8, 62, 8, 8, 0, 0}},
        {0x2c, {0, 0, 0, 0, 0, 8, 8, 16}},
        {0x2d, {0, 0, 0, 126, 0, 0, 0, 0}},
        {0x2e, {0, 0, 0, 0, 0, 24, 24, 0}},
        {0x2f, {0, 2, 4, 8, 16, 32, 64, 0}},
        {0x30, {60, 66, 70, 90, 98, 66, 60, 0}},
        {0x31, {8, 24, 40, 8, 8, 8, 62, 0}},
        {0x32, {60, 66, 2, 12, 48, 64, 126, 0}},
        {0x33, {60, 66, 2, 28, 2, 66, 60, 0}},
        {0x34, {4, 12, 20, 36, 126, 4, 4, 0}},
        {0x35, {126, 64, 124, 2, 2, 66, 60, 0}},
        {0x36, {28, 32, 64, 124, 66, 66, 60, 0}},
        {0x37, {126, 2, 4, 8, 16, 16, 16, 0}},
        {0x38, {60, 66, 66, 60, 66, 66, 60, 0}},
        {0x39, {60, 66, 66, 62, 2, 4, 56, 0}},
        {0x3a, {0, 0, 8, 0, 0, 8, 0, 0}},
        {0x3b, {0, 0, 8, 0, 0, 8, 8, 16}},
        {0x3c, {14, 24, 48, 96, 48, 24, 14, 0}},
        {0x3d, {0, 0, 126, 0, 126, 0, 0, 0}},
        {0x3e, {112, 24, 12, 6, 12, 24, 112, 0}},
        {0x3f, {60, 66, 2, 12, 16, 0, 16, 0}},
        {0x40, {28, 34, 74, 86, 76, 32, 30, 0}},
        {0x41, {24, 36, 66, 126, 66, 66, 66, 0}},
        {0x42, {124, 34, 34, 60, 34, 34, 124, 0}},
        {0x43, {28, 34, 64, 64, 64, 34, 28, 0}},
        {0x44, {120, 36, 34, 34, 34, 36, 120, 0}},
        {0x45, {126, 64, 64, 120, 64, 64, 126, 0}},
        {0x46, {126, 64, 64, 120, 64, 64, 64, 0}},
        {0x47, {28, 34, 64, 78, 66, 34, 28, 0}},
        {0x48, {66, 66, 66, 126, 66, 66, 66, 0}},
        {0x49, {28, 8, 8, 8, 8, 8, 28, 0}},
        {0x4a, {14, 4, 4, 4, 4, 68, 56, 0}},
        {0x4b, {66, 68, 72, 112, 72, 68, 66, 0}},
        {0x4c, {64, 64, 64, 64, 64, 64, 126, 0}},
        {0x4d, {66, 102, 90, 90, 66, 66, 66, 0}},
        {0x4e, {66, 98, 82, 74, 70, 66, 66, 0}},
        {0x4f, {24, 36, 66, 66, 66, 36, 24, 0}},
        {0x50, {124, 66, 66, 124, 64, 64, 64, 0}},
        {0x51, {24, 36, 66, 66, 74, 36, 26, 0}},
        {0x52, {124, 66, 66, 124, 72, 68, 66, 0}},
        {0x53, {60, 66, 64, 60, 2, 66, 60, 0}},
        {0x54, {62, 8, 8, 8, 8, 8, 8, 0}},
        {0x55, {66, 66, 66, 66, 66, 66, 60, 0}},
        {0x56, {66, 66, 66, 36, 36, 24, 24, 0}},
        {0x57, {66, 66, 66, 90, 90, 102, 66, 0}},
        {0x58, {66, 66, 36, 24, 36, 66, 66, 0}},
        {0x59, {34, 34, 34, 28, 8, 8, 8, 0}},
        {0x5a, {126, 2, 4, 24, 32, 64, 126, 0}},
        {0x5b, {60, 32, 32, 32, 32, 32, 60, 0}},
        {0x5c, {0, 64, 32, 16, 8, 4, 2, 0}},
        {0x5d, {60, 4, 4, 4, 4, 4, 60, 0}},
        {0x5e, {8, 20, 34, 0, 0, 0, 0, 0}},
        {0x5f, {0, 0, 0, 0, 0, 0, 127, 0}},
        {0x60, {32, 16, 8, 0, 0, 0, 0, 0}},
        {0x61, {0, 0, 56, 4, 60, 68, 58, 0}},
        {0x62, {64, 64, 92, 98, 66, 98, 92, 0}},
        {0x63, {0, 0, 60, 66, 64, 66, 60, 0}},
        {0x64, {2, 2, 58, 70, 66, 70, 58, 0}},
        {0x65, {0, 0, 60, 66, 126, 64, 60, 0}},
        {0x66, {12, 18, 16, 124, 16, 16, 16, 0}},
        {0x67, {0, 0, 58, 70, 70, 58, 2, 60}},
        {0x68, {64, 64, 92, 98, 66, 66, 66, 0}},
        {0x69, {8, 0, 24, 8, 8, 8, 28, 0}},
        {0x6a, {4, 0, 12, 4, 4, 4, 68, 56}},
        {0x6b, {64, 64, 68, 72, 80, 104, 68, 0}},
        {0x6c, {24, 8, 8, 8, 8, 8, 28, 0}},
        {0x6d, {0, 0, 118, 73, 73, 73, 73, 0}},
        {0x6e, {0, 0, 92, 98, 66, 66, 66, 0}},
        {0x6f, {0, 0, 60, 66, 66, 66, 60, 0}},
        {0x70, {0, 0, 124, 66, 66, 124, 64, 64}},
        {0x71, {0, 0, 62, 66, 66, 62, 2, 2}},
        {0x72, {0, 0, 92, 98, 64, 64, 64, 0}},
        {0x73, {0, 0, 62, 64, 60, 2, 124, 0}},
        {0x74, {16, 16, 124, 16, 16, 18, 12, 0}},
        {0x75, {0, 0, 66, 66, 66, 70, 58, 0}},
        {0x76, {0, 0, 66, 66, 66, 36, 24, 0}},
        {0x77, {0, 0, 65, 73, 73, 73, 54, 0}},
        {0x78, {0, 0, 66, 36, 24, 36, 66, 0}},
        {0x79, {0, 0, 66, 66, 70, 58, 2, 60}},
        {0x7a, {0, 0, 126, 4, 24, 32, 126, 0}},
        {0x7b, {12, 16, 16, 32, 16, 16, 12, 0}},
        {0x7c, {8, 8, 8, 8, 8, 8, 8, 8}},
        {0x7d, {48, 8, 8, 4, 8, 8, 48, 0}},
        {0x7e, {0, 0, 0, 50, 76, 0, 0, 0}}};
    for (auto& c : ascii) {
    ...
    charmap.unicode = {
        ...
        {0x250c, {0, 0, 0, 0, 15, 8, 8, 8}},
        {0x2510, {0, 0, 0, 0, 248, 8, 8, 8}},
        {0x2514, {8, 8, 8, 8, 15, 0, 0, 0}},
        {0x2518, {8, 8, 8, 8, 248, 0, 0, 0}},
        {0x251c, {8, 8, 8, 8, 15, 8, 8, 8}},
        {0x2524, {8, 8, 8, 8, 248, 8, 8, 8}},
        {0x252c, {0, 0, 0, 0, 255, 8, 8, 8}},
        {0x2534, {8, 8, 8, 8, 255, 0, 0, 0}},
        {0x253c, {8, 8, 8, 8, 255, 8, 8, 8}},
        {0x256d, {0, 0, 0, 0, 3, 4, 8, 8}},
        {0x256e, {0, 0, 0, 0, 224, 16, 8, 8}},
        {0x256f, {8, 8, 8, 16, 224, 0, 0, 0}},
        {0x2570, {8, 8, 8, 4, 3, 0, 0, 0}},
        ...
        {0x2581, {0, 0, 0, 0, 0, 0, 0, 255}},
        {0x2582, {0, 0, 0, 0, 0, 0, 255, 255}},
        {0x2583, {0, 0, 0, 0, 0, 255, 255, 255}},
        {0x2584, {0, 0, 0, 0, 255, 255, 255, 255}},
        ...
        {0x258c, {240, 240, 240, 240, 240, 240, 240, 240}},
        {0x258d, {224, 224, 224, 224, 224, 224, 224, 224}},
        {0x258e, {192, 192, 192, 192, 192, 192, 192, 192}},
        {0x258f, {128, 128, 128, 128, 128, 128, 128, 128}},
        ...
        {0x2594, {255, 0, 0, 0, 0, 0, 0, 0}},
        {0x2595, {1, 1, 1, 1, 1, 1, 1, 1}},
        {0x2596, {0, 0, 0, 0, 240, 240, 240, 240}},
        {0x2597, {0, 0, 0, 0, 15, 15, 15, 15}},
        {0x2598, {240, 240, 240, 240, 0, 0, 0, 0}},
        ...
        {0xe000, {128, 128, 128, 128, 128, 128, 128, 255}},
        {0xe001, {1, 1, 1, 1, 1, 1, 1, 255}},
        {0xe002, {255, 128, 128, 128, 128, 128, 128, 128}},
        {0xe003, {255, 1, 1, 1, 1, 1, 1, 1}},
        {0xe004, {0, 255, 0, 0, 0, 0, 0, 0}},
        {0xe005, {0, 0, 255, 0, 0, 0, 0, 0}},
        {0xe006, {0, 0, 0, 255, 0, 0, 0, 0}},
        {0xe007, {0, 0, 0, 0, 0, 255, 0, 0}},
        {0xe008, {0, 0, 0, 0, 0, 0, 255, 0}},
        {0xe009, {64, 64, 64, 64, 64, 64, 64, 64}},
        {0xe00a, {32, 32, 32, 32, 32, 32, 32, 32}},
        {0xe00b, {16, 16, 16, 16, 16, 16, 16, 16}},
        {0xe00c, {4, 4, 4, 4, 4, 4, 4, 4}},
        {0xe00d, {2, 2, 2, 2, 2, 2, 2, 2}},
        {0xe00e, {0, 60, 126, 126, 126, 126, 60, 0}},
        {0xe00f, {0, 60, 66, 66, 66, 66, 60, 0}},
        {0xe010, {170, 85, 170, 85, 170, 85, 170, 85}},
        {0xe011, {160, 80, 160, 80, 160, 80, 160, 80}},
        {0xe012, {0, 0, 0, 0, 170, 85, 170, 85}},
        {0xe013, {204, 204, 51, 51, 204, 204, 51, 51}},
        {0xe014, {204, 102, 51, 153, 204, 102, 51, 153}},
        {0xe015, {153, 51, 102, 204, 153, 51, 102, 204}},
        {0xe016, {255, 255, 0, 0, 0, 0, 0, 0}},
        {0xe017, {255, 255, 255, 0, 0, 0, 0, 0}},
        {0xe018, {3, 3, 3, 3, 3, 3, 3, 3}},
        {0xe019, {7, 7, 7, 7, 7, 7, 7, 7}},
        // original pet forms
        {0xe035, {126, 64, 120, 4, 2, 68, 56, 0}},
        {0xe037, {126, 66, 4, 8, 16, 16, 16, 0}},
        {0xe070, {0, 0, 92, 98, 98, 92, 64, 64}},
        {0xe071, {0, 0, 58, 70, 70, 58, 2, 2}},
        // MZ80-like
        ...
        {0xe107, {0, 192, 200, 84, 84, 85, 34, 0}},
        {0xe108, {65, 162, 60, 90, 126, 36, 54, 0}},
        {0xe109, {130, 70, 60, 90, 126, 255, 36, 108}},
        // specials
        ...
        {0x1fb70, {64, 64, 64, 64, 64, 64, 64, 64}},
        {0x1fb71, {32, 32, 32, 32, 32, 32, 32, 32}},
        {0x1fb72, {16, 16, 16, 16, 16, 16, 16, 16}},
        {0x1fb73, {8, 8, 8, 8, 8, 8, 8, 8}},
        {0x1fb74, {4, 4, 4, 4, 4, 4, 4, 4}},
        {0x1fb75, {2, 2, 2, 2, 2, 2, 2, 2}},
        {0x1fb76, {0, 255, 0, 0, 0, 0, 0, 0}},
        {0x1fb77, {0, 0, 255, 0, 0, 0, 0, 0}},
        {0x1fb78, {0, 0, 0, 255, 0, 0, 0, 0}},
        {0x1fb79, {0, 0, 0, 0, 255, 0, 0, 0}},
        {0x1fb7a, {0, 0, 0, 0, 0, 255, 0, 0}},
        {0x1fb7b, {0, 0, 0, 0, 0, 0, 255, 0}},
        {0x1fb7c, {128, 128, 128, 128, 128, 128, 128, 255}},
        {0x1fb7d, {255, 128, 128, 128, 128, 128, 128, 128}},
        {0x1fb7e, {255, 1, 1, 1, 1, 1, 1, 1}},
        {0x1fb7f, {1, 1, 1, 1, 1, 1, 1, 255}},
        {0x1fb80, {255, 0, 0, 0, 0, 0, 0, 255}},
        {0x1fb81, {255, 0, 255, 0, 255, 0, 0, 255}},
        {0x1fb82, {255, 255, 0, 0, 0, 0, 0, 0}},
        {0x1fb83, {255, 255, 255, 0, 0, 0, 0, 0}},
        {0x1fb84, {255, 255, 255, 255, 255, 0, 0, 0}},
        {0x1fb85, {255, 255, 255, 255, 255, 255, 0, 0}},
        {0x1fb86, {255, 255, 255, 255, 255, 255, 255, 0}},
        {0x1fb87, {3, 3, 3, 3, 3, 3, 3, 3}},
        {0x1fb88, {7, 7, 7, 7, 7, 7, 7, 7}},
        {0x1fb89, {31, 31, 31, 31, 31, 31, 31, 31}},
        {0x1fb8a, {63, 63, 63, 63, 63, 63, 63, 63}},
        {0x1fb8b, {127, 127, 127, 127, 127, 127, 127, 127}},
        {0x1fb8c, {160, 80, 160, 80, 160, 80, 160, 80}},
        {0x1fb8d, {10, 5, 10, 5, 10, 5, 10, 5}},
        {0x1fb8e, {170, 85, 170, 85, 0, 0, 0, 0}},
        {0x1fb8f, {0, 0, 0, 0, 170, 85, 170, 85}},
