...
char32_t PETSCII::realPETSCIItoUnicode(uint8_t petscii, bool shiftedFont) {
    static char32_t unshifted[256]
        = {
              /* 0x00, */ 0x00000000, // (-) undefined
              /* 0x01, */ 0x00000001, // (-) undefined
              /* 0x02, */ 0x00000002, // (-) undefined
              ...
              /* 0x5A, */ 0x0000005A, // (-) Z
              /* 0x5B, */ 0x0000005B, // (-) [
              /* 0x5C, */ 0x000000A3, // (*) pound sign
              /* 0x5D, */ 0x0000005D, // (-) ]
              /* 0x5E, */ 0x00002191, // (!) arrow up
              /* 0x5F, */ 0x00002190, // (!) arrow left

              /* 0x60, */ 0x00002501, // (!) box drawings light horizontal
              /* 0x61, */ 0x00002660, // (!) black spade suit
              /* 0x62, */ 0x00002758, // (!) LIGHT VERTICAL BAR
              /* 0x63, */ 0x00002501, // (!) BOX DRAWINGS HEAVY HORIZONTAL           1FB78, // (!) box drawings light horizontal
              /* 0x64, */ 0x0001FB77, // (!) box drawings light horizontal one quarter up
              /* 0x65, */ 0x0001FB76, // (!) box drawings light horizontal two quarters up (bad)
              /* 0x66, */ 0x0001FB7A, // (!) box drawings light horizontal one quarter down
              /* 0x67, */ 0x0001FB71, // (!) box drawings light vertical one quarter left
              /* 0x68, */ 0x0001FB74, // (!) box drawings light vertical one quarter right
              /* 0x69, */ 0x0000256E, // (!) box drawings light arc down and left
              /* 0x6A, */ 0x00002570, // (!) box drawings light arc up and right
              /* 0x6B, */ 0x0000256F, // (!) box drawings light arc up and left
              /* 0x6C, */ 0x0001FB7C, // (!) bottom left corner
              /* 0x6D, */ 0x00002572, // (!) box drawings light diagonal upper left to lower right
              /* 0x6E, */ 0x00002571, // (!) box drawings light diagonal upper right to lower left
              /* 0x6F, */ 0x0001FB7D, // (!) top left corner

              /* 0x70, */ 0x0001FB7E, // (!) top right corner
              /* 0x71, */ 0x000025CF, // (!) black circle
              /* 0x72, */ 0x0001FB7B, // (!) box drawings light horizontal two quarters down
              /* 0x73, */ 0x00002665, // (!) black heart suit
              /* 0x74, */ 0x0001FB70, // (!) box drawings light vertical two quarters left
              /* 0x75, */ 0x0000256D, // (!) box drawings light arc down and right
              /* 0x76, */ 0x00002573, // (!) box drawings light diagonal cross
              /* 0x77, */ 0x000025CB, // (!) donut
              /* 0x78, */ 0x00002663, // (!) black club suit
              /* 0x79, */ 0x0001FB75, // (!) box drawings light vertical two quarters right
              ...
              /* 0xF8, */ 0x0001FB83, // (!) upper three eights block
              /* 0xF9, */ 0x00002583, // (!) lower three eights block
              /* 0xFA, */ 0x0001FB7F, // (!) bottom right corner
              /* 0xFB, */ 0x00002596, // (!) black small square lower left
              /* 0xFC, */ 0x0000259D, // (!) black small square upper right
              /* 0xFD, */ 0x0000251b, // (!) box drawings heavy up and left
              /* 0xFE, */ 0x00002598, // (!) black small square upper left
              /* 0xFF, */ 0x000003C0, // (!) greek small letter pi
          };

    static char32_t shifted[256]
        = {
              /* 0x00, */ 0x00000000, // (-) undefined
              /* 0x01, */ 0x00000001, // (-) undefined
              /* 0x02, */ 0x00000002, // (-) undefined
              ...
              /* 0x7C, */ 0x0001FB8C, // (!) LEFT HALF MEDIUM SHADE
              /* 0x7D, */ 0x00002503, // (!) box drawings heavy vertical
              /* 0x7E, */ 0x00002592, // (!) medium shade
              /* 0x7F, */ 0x0001FB98, // (!) UPPER LEFT TO LOWER RIGHT FILL '\\'
              ...
              /* 0xDE, */ 0x00002592, // (!) medium shade
              /* 0xDF, */ 0x0001FB98, // (!) UPPER LEFT TO LOWER RIGHT FILL '\\'
    ...
    if (shiftedFont) {
        return shifted[petscii];
    }
    return unshifted[petscii];
}