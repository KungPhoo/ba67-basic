...
void CharMap::init(char32_t from, char32_t to) {
    ...
    static DataStruct stTableAscii[] = {
...
// Basic Latin
        ...
        {                 0x34, { 0x06, 0x0e, 0x1e, 0x66, 0x7f, 0x06, 0x06, 0x00 } }, // 4
        {                 0x35, { 0x7e, 0x60, 0x7c, 0x06, 0x06, 0x66, 0x3c, 0x00 } }, // 5
        {                 0x36, { 0x3c, 0x66, 0x60, 0x7c, 0x66, 0x66, 0x3c, 0x00 } }, // 6
        {                 0x37, { 0x7e, 0x66, 0x0c, 0x18, 0x18, 0x18, 0x18, 0x00 } }, // 7
        ...
        {                 0x5c,                      { 0, 64, 32, 16, 8, 4, 2, 0 } }, // {, {0x0c ,0x12 ,0x30 ,0x7c ,0x30 ,0x62 ,0xfc, 0x00}}, // pound
        {                 0x5d, { 0x3c, 0x0c, 0x0c, 0x0c, 0x0c, 0x0c, 0x3c, 0x00 } }, // ]
        {                 0x5e,                       { 8, 20, 34, 0, 0, 0, 0, 0 } }, // {0x5e, {0x00 ,0x18 ,0x3c ,0x7e ,0x18 ,0x18 ,0x18, 0x18}}, // arrow up
        {                 0x5f,                       { 0, 0, 0, 0, 0, 0, 127, 0 } }, // {0x5f, {0x00 ,0x10 ,0x30 ,0x7f ,0x7f ,0x30 ,0x10, 0x00}}, // arrow left
        {                 0x60,                       { 32, 16, 8, 0, 0, 0, 0, 0 } }, // `
        {                 0x61, { 0x00, 0x00, 0x3c, 0x06, 0x3e, 0x66, 0x3e, 0x00 } }, // a
        {                 0x62, { 0x00, 0x60, 0x60, 0x7c, 0x66, 0x66, 0x7c, 0x00 } },
        {                 0x63, { 0x00, 0x00, 0x3c, 0x60, 0x60, 0x60, 0x3c, 0x00 } },
        {                 0x64, { 0x00, 0x06, 0x06, 0x3e, 0x66, 0x66, 0x3e, 0x00 } },
        {                 0x65, { 0x00, 0x00, 0x3c, 0x66, 0x7e, 0x60, 0x3c, 0x00 } },
        {                 0x66, { 0x00, 0x0e, 0x18, 0x3e, 0x18, 0x18, 0x18, 0x00 } },
        {                 0x67, { 0x00, 0x00, 0x3e, 0x66, 0x66, 0x3e, 0x06, 0x7c } },
        {                 0x68, { 0x00, 0x60, 0x60, 0x7c, 0x66, 0x66, 0x66, 0x00 } },
        {                 0x69, { 0x00, 0x18, 0x00, 0x38, 0x18, 0x18, 0x3c, 0x00 } },
        {                 0x6a, { 0x00, 0x06, 0x00, 0x06, 0x06, 0x06, 0x06, 0x3c } },
        {                 0x6b, { 0x00, 0x60, 0x60, 0x6c, 0x78, 0x6c, 0x66, 0x00 } },
        {                 0x6c, { 0x00, 0x38, 0x18, 0x18, 0x18, 0x18, 0x3c, 0x00 } },
        ...
        {                 0x74, { 0x00, 0x18, 0x7e, 0x18, 0x18, 0x18, 0x0e, 0x00 } },
...
#endif
        { char32_t(0xffffffff),                         { 0, 0, 0, 0, 0, 0, 0, 0 } }
    };

    for (size_t i = 0; stTableAscii[i].c != 0xffffffff; ++i) {
        auto& c = stTableAscii[i];
        std::swap(this->ascii[c.c], c.b);
    }

    // for (auto& c : tableascii) {
    //     std::swap(this->ascii[c.first], c.second);
    // }

    static DataStruct stTableUnicode[] = {
    // Latin-1
        ...
        {    0x000B2, { 0x00, 0x18, 0x0c, 0x18, 0x3c, 0x00, 0x00, 0x00 } }, // SUPERSCRIPT TWO
    ...
    for (size_t i = 0; stTableUnicode[i].c != 0xffffffff; ++i) {
        auto& c = stTableUnicode[i];
        if (c.c >= from && c.c <= to) {
            this->at(c.c) = c.b;
        }
    }

    // for (auto& c : tableUnicode) {
