...
echo might need pi-bluetooth
sudo apt install -y git g++ cmake make ninja-build xserver-xorg xinit x11-xserver-utils alsa-utils openbox python3-xdg pulseaudio fluidsynth abcmidi bluez bluez-tools
